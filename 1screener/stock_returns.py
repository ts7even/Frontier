...
def regres_criteria():
    df1 = pd.read_csv('source/data_screener/sp_regression.csv') # Regression
    df2 = pd.read_csv('source/data_screener/sp_returns.csv') # Returns
    ...
    df1.to_csv('source/data_screener/Stats_Summary.csv')
